...
def answer_seven():
    ...
    columns = ['POPESTIMATE2010',
               ...
               'POPESTIMATE2014',
               'POPESTIMATE2015']
    max_value = counties_df[columns].max(axis = 1) #axis = 1 means find the max value of columns
...
def answer_eight():
    counties_df = census_df[census_df['SUMLEV'] == 50]
    return counties_df[((counties_df['REGION'] == 1) | (counties_df['REGION'] == 2)) & (counties_df['CTYNAME'] == 'Washington County') & (counties_df['POPESTIMATE2015'] > counties_df['POPESTIMATE2014'])][['STNAME','CTYNAME']]
